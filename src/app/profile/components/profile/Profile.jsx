...
export default function Profile() {
  return (
    <div className="w-full md:max-w-[1440px]">
      <div className="w-[85%] mx-auto h-[auto] flex md:flex-row flex-col items-center py-10 gap-x-6">
        ...
        <div className="w-full flex flex-col md:flex-row items-baseline">
          <div className="w-full">
            <h1 className="font-semibold text-3xl text-center md:text-left pt-4 md:pt-0 mb-3">Jane Doe</h1>
          ...
          <button className="md:mx-auto border border-[2px #26BDD2] px-3 rounded-md mt-5 md:mt-0">Edit</button>
        </div>
      </div>

      <div className="w-[85%] mx-auto mt-5 mb-8 ">
